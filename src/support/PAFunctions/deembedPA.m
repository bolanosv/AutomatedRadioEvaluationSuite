function [inCal,outCal] = deembedPA(mode, freq, RFInputPower, inFixedAtt, outFixedAtt, inSpFile, outSpFile, driverFile)
    ...
    if strcmp(mode, "None")
        ...
        inCal = 0;
        outCal = 0;
    elseif strcmp(mode, "Fixed Attenuation")
    ...
    elseif strcmp(mode, "Small Signal")
        ...
        SnP_in = sparameters(inSpFile);
        SnP_out = sparameters(outSpFile);
        ...
        inCal = inFixedAtt + Att_in;
        outCal = outFixedAtt + Att_out;
    elseif strcmp(mode, "Small + Large Signal")
        ...
        inCal = inFixedAtt + Att_in - driverGain;
    end
end