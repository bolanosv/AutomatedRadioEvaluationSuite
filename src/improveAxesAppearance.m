function improveAxesAppearance(axesObj, varargin)
    % Improve the appearance of axes in MATLAB App Designer
    % axesObj:       Handle to the UIAxes object
    % varargin:      Optional name-value pairs for 'YYAxis', 'LineWidth', etc.
    % YYAxis:        Boolean flag, to handle plots with graphs on the left and
